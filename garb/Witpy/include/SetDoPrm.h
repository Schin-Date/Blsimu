...
//
    ...
    SetDoPrm(const std::string doprmfilename);
//    SetDoPrm(const std::string doprmfilename, const std::string logfilename)
//                            {ReadDoPrm(doprmfilename, logfilename);}
	virtual ~SetDoPrm();
    const int ReadDoPrm(const std::string doprmfilename, const std::string logfilename);
