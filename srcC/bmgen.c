...
#include	<string.h>
//#include <const.h>
//#include <plnck.h> << does not work in c.
#include "main.h"
...
//      CREGX = (double)( 1 - ITHETX + ISGALX ) * PAI / 2.;
       CREGX = (double)( 1 - ITHETX + ISGALX ) * M_PI / 2.;
/*...PhiX */
...
/*...Region assignment */
      ...
      CREGY = (double)( 1 - ITHETY + ISGALY ) * M_PI / 2.;
/*...PhiY */
...
//     EMASS = plnck::electron_mass_c2;
//     pp  = sqrt(E*E - plnck::EMASS*plnck::EMASS);
