...
//unused double x0, xp0, y0, yp0, x1, xp1, y1, yp1, x2, xp2, y2, yp2, x, xp, y, yp;
double x0, xp0, y0, yp0, x1, y1, x2;
//unused double el, pel, px,py,pz,pt2,pp2;
//unused double el, pel, px,py,pz;
double el, px,py,pz;
double z0,  z1,  z2;
