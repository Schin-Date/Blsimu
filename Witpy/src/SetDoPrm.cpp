...
//    PyRun_SimpleString("sys.path.append('../srcPy')");
    ...
    //OK in make NG in cmake    std::string witpy_path_s ="sys.path.append('"WITPY_SRCDIR"')";
    std::string tmpstr = WITPY_SRCDIR;
    //std::cout<<"DDD...tmpstr : "<<tmpstr<<std::endl;
    std::string witpy_path_s ="sys.path.append('"+tmpstr+"')";
