...
//PhysicalConstants.h
//
// Authors: M.Maire, S.Giani modified by S. D.
//
// History:
//
// 06.02.96   Created.
...
#ifndef CLHEP_SYSTEM_OF_UNITS_H
#define CLHEP_SYSTEM_OF_UNITS_H
...
namespace plnck {
  ...
  static const double microradian = 1.e-6*radian;
  ...
  static const double urad = microradian;
  ...
  // Time [T]
  //
//original  static const double nanosecond  = 1.;
//original  static const double second      = 1.e+9 *nanosecond;
  static const double second      = 1.;
  static const double minuit      = 60. *second;
  static const double hour      = 60. *minuit;
  ...
  static const double min = minuit;
...
//131022  static const double e_SI  = 1.602176487e-19;// positron charge
  static const double e_SI  = 1.602176565e-19;// positron charge in coulomb
